    ...
    return selectedProduct && (
        <div className="mt-12">
            <p>
                ...
                <Link to={`/products/${selectedProduct.category.toLowerCase()}`}> {selectedProduct.category}</Link> /
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="mt-6">
                        <p className="text-gray-500/70 line-through">MRP:{currency}{selectedProduct.price}</p>
                        <p className="text-2xl font-medium">MRP: {currency}{selectedProduct.offerPrice}</p>
